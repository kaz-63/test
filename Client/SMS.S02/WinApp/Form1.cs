...
namespace WinApp
{
    public partial class Form1 : SystemBase.Forms.BaseLogin
    {
        ...
        protected override void InitializeLoadControl()
        {
            ...
            this.txtShukkaFlag.Text= SHUKKA_FLAG.AR_VALUE1;
            this.txtNonyusakiCD.Text = "10";
            this.txtBoxNo.Text = "B00001";
        }
        ...
        protected override void btnLogin_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (this.ExecuteLogin(this.txtUserID.Text, this.txtPassword.Text, ref errorMsgID))
                {
                    ...
                    string shukkaFlag = this.txtShukkaFlag.Text;
                    string nonyusakiCD = this.txtNonyusakiCD.Text;
                    string boxNo = this.txtBoxNo.Text;
                    ...
                    if (itemID == "S0200020")
                    {
                        obj = type.InvokeMember(null,
                                                       ...
                                                       null,
                                                       null,
                                                       new object[] { this.UserInfo, shukkaFlag, nonyusakiCD, "納入先名","flag","AR9999",boxNo });
                    }
                    else
                    {
                        obj = type.InvokeMember(null,
        ...
        private void InitializeExecuteClass()
        {
            ...
            string categoryID = "S02";
            string nameSpace = "SMS." + categoryID + ".Forms.";
            // S0200010 : 出荷情報登録
            {
                DataRow dr = dt.NewRow();
                dr["Title"] = "出荷情報登録";
                dr["ClassName"] = nameSpace + "ShukkaJoho";
            ...
            // S0200020 : 出荷情報明細
            {
                DataRow dr = dt.NewRow();
                dr["Title"] = "出荷情報明細";
                dr["ClassName"] = nameSpace + "ShukkaJohoMeisai";
                dr["CategoryID"] = categoryID;
                dr["ItemID"] = "S0200020";
                dt.Rows.Add(dr);
            }
            // S0200030 : 出荷情報照会
            {
                DataRow dr = dt.NewRow();
                dr["Title"] = "出荷情報照会";
                dr["ClassName"] = nameSpace + "ShukkaJohoShokai";
                dr["CategoryID"] = categoryID;
                dr["ItemID"] = "S0200040";
                dt.Rows.Add(dr);
            }
