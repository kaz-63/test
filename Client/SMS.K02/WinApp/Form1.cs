...
namespace WinApp
{
    public partial class Form1 : SystemBase.Forms.BaseLogin
    {
        ...
        private void InitializeExecuteClass()
        {
            ...
            string categoryID = "K02";
            string nameSpace = "SMS." + categoryID + ".Forms.";
            // K0200010 : ラベル発行
            {
                DataRow dr = dt.NewRow();
                dr["ComboText"] = "Label Print";
                dr["Title"] = "Label Print";
                dr["ClassName"] = nameSpace + "LabelInsatsu";
            ...
            {
                DataRow dr = dt.NewRow();
                dr["ComboText"] = "Box List Print";
                dr["Title"] = "Box List Print";
                dr["ClassName"] = nameSpace + "BoxListHakko";
                dr["CategoryID"] = categoryID;
                dr["ItemID"] = "K0200020";
                dt.Rows.Add(dr);
            }
            ...
            {
                DataRow dr = dt.NewRow();
                dr["ComboText"] = "Pallet List Print";
                dr["Title"] = "Pallet List Print";
                dr["ClassName"] = nameSpace + "PalletListHakko";
                dr["CategoryID"] = categoryID;
                dr["ItemID"] = "K0200030";
                dt.Rows.Add(dr);
            }
            // K0200040 : 木枠梱包登録
            {
                ...
                dr["ComboText"] = "木枠梱包登録";
                dr["Title"] = "木枠梱包登録";
                dr["ClassName"] = nameSpace + "KiwakuKonpo";
                dr["CategoryID"] = categoryID;
                dr["ItemID"] = "K0200040";
                dt.Rows.Add(dr);
            }
            ...
            //    DataRow dr = dt.NewRow();
            //    dr["Title"] = "木枠梱包明細登録";
            //    dr["ClassName"] = nameSpace + "KiwakuKonpoMeisai";
            //    dr["CategoryID"] = categoryID;
            //    dr["ItemID"] = "K0200050";
            //    dt.Rows.Add(dr);
            //}
            ...
            //{
            //    DataRow dr = dt.NewRow();
            //    dr["ComboText"] = "木枠梱包登録(社外)";
            //    dr["Title"] = "木枠梱包登録(社外)";
            //    dr["ClassName"] = nameSpace + "ShagaiKiwakuKonpo";
            //    dr["CategoryID"] = categoryID;
            //    dr["ItemID"] = "K0200060";
            //    dt.Rows.Add(dr);
            //}
            //// K0200070 : 木枠梱包明細登録(社外)
            //{
            //    DataRow dr = dt.NewRow();
            //    dr["Title"] = "木枠梱包明細登録(社外)";
            //    dr["ClassName"] = nameSpace + "ShagaiKiwakuKonpoMeisai";
            //    dr["CategoryID"] = categoryID;
            //    dr["ItemID"] = "K0200070";
            //    dt.Rows.Add(dr);
            //}
            ...
            {
                DataRow dr = dt.NewRow();
                dr["ComboText"] = "Packing List Print";
                dr["Title"] = "Packing List Print";
                dr["ClassName"] = nameSpace + "PackingListHakko";
                dr["CategoryID"] = categoryID;
                dr["ItemID"] = "K0200100";
                dt.Rows.Add(dr);
            }
            ...
            // データソースの設定
            this.cboClass.DisplayMember = "ComboText";
