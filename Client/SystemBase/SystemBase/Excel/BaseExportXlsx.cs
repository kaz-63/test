...
namespace SystemBase.Excel
{
    ...
    public class BaseExportXlsx
    {
        ...
        protected virtual bool PutSimpleExcel(string filePath, DataTable dt, ExportInfoCollection expInfoCollection, ref string msgID, ref string[] args)
        {
            try
            {
                using (XlsxCreator xlsx = new XlsxCreator())
                {
                    ...
                    xlsx.CreateBook(filePath, 1, xlVersion.ver2007);
        ...
        /// <returns>true:成功/false:失敗</returns>
        /// <create>K.Tsutsumi 2019/03/09</create>
        /// <update>J.Chen 2023/12/18 小数点第2位まで対応修正</update>
        /// <update></update>
        /// --------------------------------------------------
        ...
        /// <update></update>
        /// --------------------------------------------------
        protected virtual bool PutSimpleExcelPutData(XlsxCreator xlsx, DataTable dt, ExportInfoCollection expInfoCollection, ref string msgID, ref string[] args)
        {
            int col = expInfoCollection.StartCol;
        ...
        /// ヘッダ罫線出力
        /// </summary>
        /// <param name="xlsx">XlsCreator</param>
        /// <param name="dt">出力データ</param>
        /// <param name="expInfoCollection">エクスポート情報</param>
        /// <param name="msgID">メッセージID</param>
        /// <param name="args">パラメーター</param>
        ...
        /// <update></update>
        /// --------------------------------------------------
        protected virtual bool PutSimpleExcelPutHeaderLine(XlsxCreator xlsx, DataTable dt, ExportInfoCollection expInfoCollection, ref string msgID, ref string[] args)
        {
            ...
            xlsx.Pos(colStart, rowStart, colEnd, rowEnd).Attr.Box(xlBoxType.xbtLtc, xlBorderStyle.xbsThin, Color.Black);
            return true;
        }
        ...
        /// <update></update>
        /// --------------------------------------------------
        protected virtual bool PutSimpleExcelPutDataLine(XlsxCreator xlsx, DataTable dt, ExportInfoCollection expInfoCollection, ref string msgID, ref string[] args)
        {
