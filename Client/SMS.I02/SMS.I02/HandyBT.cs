...
namespace SMS.I02
{
    ...
    /// <update>T.Wakamatsu 2013/08/22</update>
    /// --------------------------------------------------
    public class HandyBT : IDisposable
    {
        #region Fields
        ...
        private string GetErrorString(BTCOMM_RESULT result)
        {
            try
            {
                ...
                case BTCOMM_RESULT.BTCOMM_BIGDATA:
                        ret = Resources.HandyBT_BtcommBigdata;
                        break;
                    case BTCOMM_RESULT.BTCOMM_CANCELED:
                        ret = Resources.HandyBT_BtcommCanceled;
                        break;
                    case BTCOMM_RESULT.BTCOMM_CONVERT_FAILED:
                        ret = Resources.HandyBT_BtcommConvertFailed;
                        break;
                    case BTCOMM_RESULT.BTCOMM_FILENOTFOUND:
                        ret = Resources.HandyBT_BtcommFilenotfound;
                        break;
                    case BTCOMM_RESULT.BTCOMM_INCOMPLETE:
                        ret = Resources.HandyBT_BtcommIncomplete;
                        break;
                    case BTCOMM_RESULT.BTCOMM_INUSE:
                        ret = Resources.HandyBT_BtcommInuse;
                        break;
                    case BTCOMM_RESULT.BTCOMM_INVALID_VALUE:
                        ret = Resources.HandyBt_BtcommInvalidvalue;
                        break;
                    case BTCOMM_RESULT.BTCOMM_NETDOWN:
                        ret = Resources.HandyBt_BtcommNetdown;
                        break;
                    case BTCOMM_RESULT.BTCOMM_NOTCONNECT:
                        ret = Resources.HandyBt_BtcommNotconnect;
                        break;
                    case BTCOMM_RESULT.BTCOMM_NOTFOUND:
                        ret += Resources.HandyBt_BtcommNotfound;
                        break;
                    case BTCOMM_RESULT.BTCOMM_NOTINITIALISED:
                        ret += Resources.HandyBt_BtcommNotinitialised;
                        break;
                    case BTCOMM_RESULT.BTCOMM_OK:
                        ret = string.Empty;
                        break;
                    case BTCOMM_RESULT.BTCOMM_OTHER:
                        ret += Resources.HandyBt_BtcommOther;
                        break;
                    case BTCOMM_RESULT.BTCOMM_REFUSED:
                        ret += Resources.HandyBt_BtcommRefused;
                        break;
                    case BTCOMM_RESULT.BTCOMM_TIMEOUT:
                        ret += Resources.HandyBt_BtcommTimeout;
                        break;
                    case BTCOMM_RESULT.BTCOMM_WOULDBLOCK:
                        ret += Resources.HandyBt_BtcommWouldblock;
                        break;
                    default:
                        ret = string.Empty;
                        break;
