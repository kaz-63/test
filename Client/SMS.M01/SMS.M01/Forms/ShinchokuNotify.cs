...
namespace SMS.M01.Forms
{
    ...
    /// <update></update>
    /// --------------------------------------------------
    public partial class ShinchokuNotify : SystemBase.Forms.CustomOrderForm
    {
        #region フィールド
        ...
        /// <update></update>
        /// --------------------------------------------------
        public ShinchokuNotify(UserInfo userInfo, string title, string bukkenNo, string bukkenName)
            : base(userInfo)
        {
            InitializeComponent();
        ...
        protected override bool RunSearchExec()
        {
            try
            {
                ...
                var dt = conn.GetShinchokuKanriNotify(cond);
            ...
            try
            {
                ...
                // 物件メールマスタ
                {
                    ...
                    dt.Rows.Add(SHUKKA_FLAG.AR_VALUE1
                        , this._bukkenNo
                        , MAIL_KBN.ARSHINCHOKU_KOBETU_VALUE1
                        , DBNull.Value
                        , this._mailHeaderId);
                    ds.Tables.Add(dt);
                }
                ...
                string errMsgID;
                string[] args;
                if (!conn.SaveShinchokuKanriNotify(cond, ds, out errMsgID, out args))
                {
