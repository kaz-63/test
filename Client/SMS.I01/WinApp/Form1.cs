...
namespace WinApp
{
    public partial class Form1 : SystemBase.Forms.BaseLogin
    {
        ...
        protected override void InitializeLoadControl()
        {
            ...
            this.txtPassword.Text = "sysadmin1";
        ...
        private void InitializeExecuteClass()
        {
            ...
            string categoryID = "I01";
            string nameSpace = "SMS." + categoryID + ".Forms.";
            // I0100010 : ロケーション保守
            {
                DataRow dr = dt.NewRow();
                dr["Title"] = "Location保守";
                dr["ClassName"] = nameSpace + "LocationHoshu";
            ...
            // I0100020 : 入庫設定
            {
                DataRow dr = dt.NewRow();
                dr["Title"] = "Location設定";
                dr["ClassName"] = nameSpace + "NyukoSettei";
                dr["CategoryID"] = categoryID;
                dr["ItemID"] = "I0100020";
                dt.Rows.Add(dr);
            }
            // I0100030 : 出庫設定
            {
                DataRow dr = dt.NewRow();
                dr["Title"] = "完了設定";
                dr["ClassName"] = nameSpace + "ShukkoSettei";
                dr["CategoryID"] = categoryID;
                dr["ItemID"] = "I0100030";
                dt.Rows.Add(dr);
            }
            // I0100040 : 棚卸差異照会
            {
                DataRow dr = dt.NewRow();
                dr["Title"] = "棚卸差異照会";
                dr["ClassName"] = nameSpace + "TanaoroshiSaiShokai";
                dr["CategoryID"] = categoryID;
                dr["ItemID"] = "I0100040";
                dt.Rows.Add(dr);
            }
            // I0100050 : 在庫問合せ・メンテ
            {
                DataRow dr = dt.NewRow();
                dr["Title"] = "在庫問合せ・メンテ";
                dr["ClassName"] = nameSpace + "ZaikoHoshu";
                dr["CategoryID"] = categoryID;
                dr["ItemID"] = "I0100050";
                dt.Rows.Add(dr);
            }
            // I0100060 : オペ履歴照会
            {
                DataRow dr = dt.NewRow();
                dr["Title"] = "作業履歴照会";
                dr["ClassName"] = nameSpace + "OpeRirekiShokai";
                dr["CategoryID"] = categoryID;
                dr["ItemID"] = "I0100060";
                dt.Rows.Add(dr);
            }
